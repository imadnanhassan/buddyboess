      ...
      <div className="mx-auto max-w-[1400px] px-4 lg:px-8 h-16 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-6">
          <div className="hidden md:flex items-center gap-4 text-neutral-600">
            ...
            <Link href="/groups" className="cursor-pointer">👥</Link>
            <Link href="/messages" className="cursor-pointer">💬</Link>
            <Link href="/photos" className="cursor-pointer">📸</Link>
            <Link href="/documents" className="cursor-pointer">📄</Link>
          </div>
          <div className="flex items-center gap-3">
            <MagnifyingGlassIcon className="h-6 w-6 text-neutral-600" />
            <BellIcon className="h-6 w-6 text-neutral-600" />
            <Link href="/shop"><ShoppingCartIcon className="h-6 w-6 text-neutral-600" /></Link>
